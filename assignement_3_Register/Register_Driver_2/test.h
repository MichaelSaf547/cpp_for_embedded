...
#include "register_D_unsigned_char.h"
#include "register_D_unsigned_short_int.h"
#include "register_D_unsigned_int.h"
...
bool test(permission type = read_and_Write, uint8 bit_number = 5)
{
    ...
    std::ofstream OutputFile("Register_Driver_2/output.txt");
